...
dataset = "C:/Users/LENOVO/OneDrive/TT_ViolenciaPolíticaGénero/Dataset_Inicial.csv"
df = pd.read_csv(dataset)
df.columns
tweets = df.Text #obtiene el texto de los tweet
...
df_temp.to_excel("C:/Users/LENOVO/OneDrive/TT_ViolenciaPolíticaGénero/data_clean.xlsx")
df_temp.to_csv("C:/Users/LENOVO/OneDrive/TT_ViolenciaPolíticaGénero/data_clean.csv", sep=',', encoding="utf-8")
